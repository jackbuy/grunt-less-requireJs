        ...
        less: { 
            ...
            dev: {
                options: {
                    ...
                    // ieCompat：true,
                    sourceMap: true,
                    sourceMapFilename: 'dist/css/<%= pkg.cssName %>.min.css.map', // where file is generated and located
                    sourceMapURL: '<%= pkg.cssName %>.min.css.map', // the complete url and filename put in the compiled css file
                    // sourceMapBasepath: '/', // Sets sourcemap base path, defaults to current working directory.
                    // sourceMapRootpath: '/', // adds this path onto the sourcemap filename and less file paths
                },
                files: [
                    {'dist/css/<%= pkg.cssName %>.min.css':'static/less/config.less' } 
                ]
            }
        },
        //压缩css
